...
<?php 
	$query = mysql_query("SELECT * FROM pages WHERE ID =" . (int) $_GET['id']);
...
<a class="brand" href="/">iOmega CMS</a>
    ...
    <div class="container">
      ...
      <div class="hero-unit">
      	<h3 style="margin-top: -20px;">Edit a Page</h3>
		<form action="doEditPage.php" method="post">
			<input type="hidden" name="id" value="<?php echo $_GET['id']; ?>" />
			<table>
			<tr>
				<td><label for="PageName">Name</label></td><td><input type="text" name="PageName" value="<?php echo $post['Title']; ?>" /></td>
			</tr>
			<tr>
				<td><label for="PageAuth">Author</label></td><td><input type="text" name="PageAuth" value="<?php echo $post['Author']; ?>" /></td>
			</tr>
			<tr>
				<td><label for="PageContent">Content</label></td>
				<td><textarea name="PageContent" id="redactor" class="textarea" name="PageContent" ><?php echo $post['Content']; ?></textarea></td>
			</tr>
			<tr>
				<td><label for="PageCats">Category</label></td>
				<td>
					<select name="PageCats">
						<?php
