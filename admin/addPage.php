...
<a class="brand" href="/">iOmega CMS</a>
    ...
    <div class="container">
      ...
      <div class="hero-unit">
      	<h3 style="margin-top: -20px;">Add a Page</h3>
      		<form action="doAddPage.php" method="post">
<table style="width: 100%;">
	<tr>
		<td><label for="PageName">Name</label></td><td><input type="text" name="PageName" /></td>
	</tr>
	<tr>
		<td><label for="PageAuth">Author</label></td><td><input type="text" name="PageAuth" /></td>
	</tr>
	<tr><td></br></td></tr>
	<tr>
		<td><label for="PageContent">Content</label></td>
		<td><textarea id="redactor" class="textarea" name="PageContent" ></textarea></td>
	</tr>
	<tr><td></br></td></tr>
	<tr>
