            ...
            <div class="hero-unit">
      	        <div id="content" style="font-size: 14px;">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#settings" data-toggle="tab">Main Settings</a></li>
                    ...
                    <div id="my-tab-content" class="tab-content">
                        ...
                        <div class="tab-pane" id="settings">
                            <h1>Main Settings</h1>
                            <p>On this page you can edit your site's main settings. All of the settings can be update by only a click of a button!</p>
                        </div>
