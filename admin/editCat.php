...
<a class="brand" href="/">iOmega CMS</a>
          <div class="nav-collapse collapse">
          	...
          	<ul class="nav" role="navigation">
                    ...
                    <li id="fat-menu" class="dropdown" class="active">
    ...
    <div class="container">
      ...
      <div class="hero-unit">
      	<h3 style="margin-top: -20px;">Edit a Category</h3>
		<form action="doEditC.php" method="post">
			<table>
				...
				<tr>
					<td colspan="2"><button type="submit" name="submit" class="btn"/>Submit!</button></td><td><input type="hidden" name="id" value="<?php echo $_GET['id']; ?>" />
				</tr>
			</table>
		</form>
      </div>
